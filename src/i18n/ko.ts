...
export const ko: Record<string, string> = {
  ...
  "settings.apiProviderModel": "기본 모델",
  "settings.apiProviderModel.desc": "사용할 모델 ID (예: gpt-4o, claude-3-opus). 확인을 클릭하여 사용 가능한 모델을 검색합니다.",
  ...
  "settings.localEmbeddingApiKey.desc": "임베딩 서버용 사용자 정의 API 키 (Google API 키를 사용하려면 비워두세요)",
  ...
  "aiWorkflow.pastePlaceholder": "Claude, GPT 등에서 출력한 Markdown(```llm-hub-workflow 블록 포함) 또는 YAML을 붙여넣기...",
