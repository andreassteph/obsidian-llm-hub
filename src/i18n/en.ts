...
export const en = {
  ...
  "settings.apiProviderModel": "Default model",
  "settings.apiProviderModel.desc": "Model ID to use (e.g. gpt-4o, claude-3-opus). Click Verify to discover available models.",
  ...
  "settings.localEmbeddingApiKey.desc": "Custom API key for embedding server (leave empty to use Google API key)",
