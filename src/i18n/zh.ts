...
export const zh: Record<string, string> = {
  ...
  "settings.apiProviderModel": "默认模型",
  "settings.apiProviderModel.desc": "要使用的模型 ID（例如 gpt-4o、claude-3-opus）。点击验证以发现可用模型。",
  ...
  "settings.localEmbeddingApiKey.desc": "嵌入服务器的自定义 API 密钥（留空使用 Google API 密钥）",
