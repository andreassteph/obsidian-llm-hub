...
export const pt: Record<string, string> = {
  ...
  "settings.apiProviderModel": "Modelo padrao",
  "settings.apiProviderModel.desc": "ID do modelo a usar (ex. gpt-4o, claude-3-opus). Clique em Verificar para descobrir modelos disponiveis.",
  ...
  "settings.localEmbeddingApiKey.desc": "Chave API personalizada para o servidor de embedding (deixe vazio para usar a chave API do Google)",
  ...
  "aiWorkflow.pastePlaceholder": "Cole o markdown (com blocos ```llm-hub-workflow) ou YAML do Claude, GPT, etc...",
