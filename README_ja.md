...
**無料・オープンソース**の Obsidian 向け AI アシスタント。Google Gemini を活用した**チャット**、**ワークフロー自動化**、**画像生成**を搭載。
...
「LLM Hub: Run Workflow」コマンドを使用すると、どこからでもワークフローを閲覧・実行できます：
